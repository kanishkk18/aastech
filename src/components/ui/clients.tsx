...
const reviews = [
        {
          name: "Rohan_dudeja",
          username: "CEO",
          body: "The web application delivered by AAS TECHNOLOGIES is nothing short of outstanding. The user interface is clean, and the performance is seamless. Highly impressed with the technical expertise and attention to detail.",
          img: "https://i.pinimg.com/564x/46/15/55/4615550ad0b619d57ae2f9b86bc909ff.jpg",
        },
        {
          name: "Anjali_sharma",
          username: "product manager",
          body: "We needed a complex web solution, and AAS exceeded all expectations. The website is fast, responsive, and intuitive. Amazing job!",
          img: "https://i.pinimg.com/564x/2e/63/9a/2e639a50b96ec82e1b9064b68c14ea0c.jpg",
        },
        {
          name: "Vikram_desai",
          username: "Founder",
          body: "Working with AAS TECHNOLOGIES has been a pleasure. Our eCommerce platform was completed ahead of schedule, and the functionality is top-notch. I highly recommend their services.",
        ...
        },
        {
          ...
          body: "The web app AAS TECHNOLOGIES delivered is secure, scalable, and user-friendly. They understood our requirements perfectly and executed them flawlessly.",
...
const ReviewCard = ({ img, name, username, body }: ReviewCardProps) => {
  return (
    <figure
      className={cn(
        "relative h-auto md:w-96 cursor-pointer m-2 overflow-hidden rounded-xl border p-4",
        // dark styles
        "border-gray-100/[.1] bg-gray-100/[.10] hover:bg-gray-50/[.15]"
      )}
    >
      ...
      <blockquote className="mt-2 text-sm text-white font-medium">{body}</blockquote>
    </figure>
  );
};
...
export default function MarqueeDemoVertical() {
  return (
    <div className=" text-center">
      <span className="pointer-events-none  lg:text-5xl md:text-5xl whitespace-pre-wrap text-gray-300  text-2xl font-semibold leading-none ">
       we are favourite of our clients
      </span>
      <div className="relative flex h-screen w-full px-4 flex-row items-center py-8 justify-center overflow-hidden rounded-lg bg-transparent">
        ...
        <Marquee
          pauseOnHover
          vertical
          className="[--duration:8s] hidden lg:flex md:flex"
        >
          {thirdRow.map((review) => (
            <ReviewCard key={review.username} {...review} />
          ))}
